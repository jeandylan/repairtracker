...
def new_virtualHost():
    ...
    host_file.write('<VirtualHost *:80> /nServerAdmin localserver@localhost \nServerName '+args.virtualHostDomain+' \nServerAlias ' +args.virtualHostDomain+ '\nDocumentRoot "/var/www/html/repairtracker/public"'+
    '\n<Directory "/var/www/html/repairtracker/public"> \nAllowoverride All \n</Directory>'+
    '\n</VirtualHost>')
    host_file.close()
