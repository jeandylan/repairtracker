 ...
 */
app.controller("createCustomerTicketCtrl",function ($scope,serverServices,toaster,$http) {
        ...
        serverServices.post('api/customer',customerData) //using service (customer/service/clientService ) that will query Laravel for .json output
            .then(
                function (result) {
                    ...
                    $scope.closeThisDialog(result.newResource); //close and pass The Selec data to the NgDialog promise
                },
                function (error) {
                    // handle errors here
